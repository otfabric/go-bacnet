...
func TestWorldietySegmentedWritePropertyMultipleSend(t *testing.T) {
	...
	t.Skip("Worldiety deviation: omits service-choice on confirmed-request segments >0; see bacnet-interop/PEER_SUPPORT.md")
}
...
func TestWorldietySegmentedReadPropertyMultiple(t *testing.T) {
	...
	t.Skip("Worldiety deviation: omits service-choice on ComplexACK segments >0; see bacnet-interop/PEER_SUPPORT.md")
}
