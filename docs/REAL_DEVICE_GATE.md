...
| **production-candidate** | Release-grade through [`v0.2.2`](https://github.com/otfabric/go-bacnet/releases/tag/v0.2.2) (Worldiety-pinned peer + broader service codecs; see [RELEASE.md](../RELEASE.md)). Does **not** require this real-device checklist. |
