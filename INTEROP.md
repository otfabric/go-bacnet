...
(BACpypes3 **0.0.106**; Worldiety digest included). Prior pin `v0.4.2` green:
[30725263801](https://github.com/otfabric/go-bacnet/actions/runs/30725263801).
...
| **production-candidate** | Current — supervisory client + oracle/lab interop evidence (`v0.2.1`; pending `v0.2.2` + pin `v0.5.0`); **no** claim of multi-vendor hardware readiness |
