...
**Status:** **production-candidate** — **[`v0.2.1`](https://github.com/otfabric/go-bacnet/releases/tag/v0.2.1)**
released; next pending minor **`v0.2.2`** (see [RELEASE.md](RELEASE.md)). Pin:
...
**Next:** human cuts **`v0.2.2`**, then the
[real-device gate](docs/REAL_DEVICE_GATE.md) toward **production-usable**.
...
| 14 | **Human:** cut `v0.2.2` | `open` | pending minor; see [RELEASE.md](RELEASE.md) |
